...
JNIEXPORT void JNICALL Java_com_github_akkoumis_ison_utility_Player_native_1createEngine(
        JNIEnv *env,
        jclass clazz,
        jint j_api_level) {
...
JNIEXPORT void JNICALL Java_com_github_akkoumis_ison_utility_Player_native_1destroyEngine(
        JNIEnv *env,
        jclass type) {
...
JNIEXPORT jobject JNICALL Java_com_github_akkoumis_ison_utility_Player_native_1createAudioPlayer(
        JNIEnv *env,
        jclass clazz,
        jint j_frame_rate,
...
JNIEXPORT void JNICALL Java_com_github_akkoumis_ison_utility_Player_native_1destroyAudioPlayer(
        JNIEnv *env,
        jclass type) {
...
JNIEXPORT void JNICALL Java_com_github_akkoumis_ison_utility_Player_native_1setFrequency(
        JNIEnv *env,
        jclass clazz,
        jfloat frequency) {
...
JNIEXPORT void JNICALL Java_com_github_akkoumis_ison_utility_Player_native_1setVolume(
        JNIEnv *env,
        jclass clazz,
        jfloat volume) {
...
JNIEXPORT void JNICALL Java_com_github_akkoumis_ison_utility_Player_native_1setPlayerPreferences(
        JNIEnv *env,
        jclass clazz,
...
JNIEXPORT void JNICALL Java_com_github_akkoumis_ison_utility_Player_native_1setSounds(
        JNIEnv *env,
        jclass clazz,
...
JNIEXPORT void JNICALL Java_com_github_akkoumis_ison_utility_Player_native_1setWorkCycles(
        JNIEnv *env,
        jclass clazz,
        jint workCycles) {
...
JNIEXPORT void JNICALL Java_com_github_akkoumis_ison_utility_Player_native_1setLoadStabilizationEnabled(
        JNIEnv *env,
        jclass clazz,
        jboolean is_enabled) {
