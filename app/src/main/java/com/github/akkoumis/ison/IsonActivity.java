...
public class IsonActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.openIsonDock) {
            ...
            dockIntent.putExtra("com.github.akkoumis.ison.currentScaleIndex", currentScaleIndex);
            dockIntent.putExtra("com.github.akkoumis.ison.base", base);
            dockIntent.putExtra("com.github.akkoumis.ison.note", note);
